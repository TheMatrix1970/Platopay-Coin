![Example-Logo](https://i.imgur.com/Z8xPECG.png)
# Platopay Masternode Setup Guide (Ubuntu 16.04)
This guide will assist you in setting up a Platopay Masternode on a Linux Server running Ubuntu 16.04. (Use at your own risk)

If you require further assistance contact the support team @ [Discord](https://discord.gg/Eusnctk)
***
## Requirements
1) **1,000  PPX coins.**
...
***Step 1***
* Download and install the Platopay wallet [here](https://platopay.io/)
***

***Step 2***
* Send EXACLY 1,000 PPX to a receive address within your wallet.
***
