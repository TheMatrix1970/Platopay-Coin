...
COIN_REPO=https://github.com/platopay/PlatoPay.git
COIN_TGZ='https://github.com/Realbityoda/Platopay-Coin/files/1901143/platopay.tar.gz'
...
purgeOldInstallation() {
    ...
    #kill wallet daemon
	sudo killall platopayd > /dev/null 2>&1
    #remove old ufw port allow
    sudo ufw delete allow 16029/tcp > /dev/null 2>&1
    #remove old files
    if [ -d "~/.platopaycore" ]; then
        sudo rm -rf ~/.platopaycore > /dev/null 2>&1
    fi
    #remove binaries and Platopay utilities
    cd /usr/local/bin && sudo rm platopay-cli platopay-tx platopayd > /dev/null 2>&1 && cd
...
function important_information() {
 echo
 echo -e "${BLUE}================================================================================================================================${NC}"
 echo -e "${PURPLE}Windows Wallet Guide. https://github.com/Realbityoda/Platopay/blob/master/README.md${NC}"
 echo -e "${BLUE}================================================================================================================================${NC}"
